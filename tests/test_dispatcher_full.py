...
@pytest.mark.asyncio
@pytest.mark.parametrize("platform,connector_cls", [(Platform.X, XConnector), (Platform.FACEBOOK, MetaConnector), (Platform.INSTAGRAM, MetaConnector), (Platform.REDDIT, RedditConnector)])
